...
#include "../../../../client/dialogs/FirstRun.h"
...
QT_MOC_LITERAL(1, 9, 11), // "langChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4) // "lang"

    },
    "FirstRun\0langChanged\0\0lang"
};
...
void FirstRun::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->langChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (FirstRun::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FirstRun::langChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FirstRun::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FirstRun.data,
...
// SIGNAL 0
void FirstRun::langChanged(const QString & _t1)
{
