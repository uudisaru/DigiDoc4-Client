...
#include "../../../../client/widgets/LabelButton.h"
...
QT_MOC_LITERAL(4, 26, 7), // "entered"
QT_MOC_LITERAL(5, 34, 4) // "left"

    },
    "LabelButton\0clicked\0\0code\0entered\0"
    "left"
};
...
void LabelButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (LabelButton::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LabelButton::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LabelButton::entered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (LabelButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LabelButton::left)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void LabelButton::clicked(int _t1)
{
...
// SIGNAL 1
void LabelButton::entered()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void LabelButton::left()
{
