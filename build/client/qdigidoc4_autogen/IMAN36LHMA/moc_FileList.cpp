...
#include "../../../../client/widgets/FileList.h"
...
QT_MOC_LITERAL(1, 9, 8), // "addFiles"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5), // "files"
QT_MOC_LITERAL(4, 25, 4), // "open"
QT_MOC_LITERAL(5, 30, 9), // "FileItem*"
QT_MOC_LITERAL(6, 40, 4), // "item"
QT_MOC_LITERAL(7, 45, 4), // "save"
QT_MOC_LITERAL(8, 50, 7) // "saveAll"

    },
    "FileList\0addFiles\0\0files\0open\0FileItem*\0"
    "item\0save\0saveAll"
};
...
void FileList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addFiles((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        case 1: _t->open((*reinterpret_cast< FileItem*(*)>(_a[1]))); break;
        case 2: _t->save((*reinterpret_cast< FileItem*(*)>(_a[1]))); break;
        ...
        {
            typedef void (FileList::*_t)(const QStringList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileList::addFiles)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject FileList::staticMetaObject = {
    { &ItemList::staticMetaObject, qt_meta_stringdata_FileList.data,
...
void *FileList::qt_metacast(const char *_clname)
{
    ...
    return ItemList::qt_metacast(_clname);
}

int FileList::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ItemList::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)
...
// SIGNAL 0
void FileList::addFiles(const QStringList & _t1)
{
