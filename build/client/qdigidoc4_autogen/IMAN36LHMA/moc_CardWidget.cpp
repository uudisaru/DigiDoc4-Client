...
#include "../../../../client/widgets/CardWidget.h"
...
QT_MOC_LITERAL(1, 11, 12), // "photoClicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 14), // "const QPixmap*"
QT_MOC_LITERAL(4, 40, 6), // "pixmap"
QT_MOC_LITERAL(5, 47, 8), // "selected"
QT_MOC_LITERAL(6, 56, 4) // "card"

    },
    "CardWidget\0photoClicked\0\0const QPixmap*\0"
    "pixmap\0selected\0card"
};
...
void CardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CardWidget *_t = static_cast<CardWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (CardWidget::*_t)(const QPixmap * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CardWidget::photoClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CardWidget::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CardWidget::selected)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CardWidget::staticMetaObject = {
    { &StyledWidget::staticMetaObject, qt_meta_stringdata_CardWidget.data,
      qt_meta_data_CardWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *CardWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "PictureInterface"))
        return static_cast< PictureInterface*>(const_cast< CardWidget*>(this));
...
// SIGNAL 0
void CardWidget::photoClicked(const QPixmap * _t1)
{
...
// SIGNAL 1
void CardWidget::selected(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
