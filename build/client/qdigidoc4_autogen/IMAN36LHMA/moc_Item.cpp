...
QT_MOC_LITERAL(3, 10, 5), // "Item*"
QT_MOC_LITERAL(4, 16, 4), // "item"
QT_MOC_LITERAL(5, 21, 6), // "remove"
QT_MOC_LITERAL(6, 28, 7), // "details"
QT_MOC_LITERAL(7, 36, 9), // "idChanged"
QT_MOC_LITERAL(8, 46, 8), // "cardCode"
QT_MOC_LITERAL(9, 55, 10), // "mobileCode"
QT_MOC_LITERAL(10, 66, 12) // "serialNumber"

    },
    "Item\0add\0\0Item*\0item\0remove\0details\0"
    "idChanged\0cardCode\0mobileCode\0"
    "serialNumber"
};
...
void Item::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->add((*reinterpret_cast< Item*(*)>(_a[1]))); break;
        case 1: _t->remove((*reinterpret_cast< Item*(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Item::add)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Item::*_t)(Item * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Item::remove)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Item::staticMetaObject = {
    { &StyledWidget::staticMetaObject, qt_meta_stringdata_Item.data,
