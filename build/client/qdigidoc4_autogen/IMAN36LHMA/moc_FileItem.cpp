...
#include "../../../../client/widgets/FileItem.h"
...
QT_MOC_LITERAL(3, 15, 9), // "FileItem*"
QT_MOC_LITERAL(4, 25, 4), // "item"
QT_MOC_LITERAL(5, 30, 8) // "download"

    },
    "FileItem\0open\0\0FileItem*\0item\0download"
};
...
void FileItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->open((*reinterpret_cast< FileItem*(*)>(_a[1]))); break;
        case 1: _t->download((*reinterpret_cast< FileItem*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (FileItem::*_t)(FileItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileItem::open)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FileItem::*_t)(FileItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileItem::download)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject FileItem::staticMetaObject = {
    { &Item::staticMetaObject, qt_meta_stringdata_FileItem.data,
...
void *FileItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileItem.stringdata0))
        return static_cast<void*>(const_cast< FileItem*>(this));
...
// SIGNAL 0
void FileItem::open(FileItem * _t1)
{
...
// SIGNAL 1
void FileItem::download(FileItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
