...
QT_MOC_LITERAL(3, 22, 6), // "finish"
QT_MOC_LITERAL(4, 29, 6), // "result"
QT_MOC_LITERAL(5, 36, 10), // "textEdited"
QT_MOC_LITERAL(6, 47, 4) // "text"

    },
    "PinDialog\0startTimer\0\0finish\0result\0"
    "textEdited\0text"
};
...
void PinDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PinDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PinDialog::startTimer)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (PinDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PinDialog::finish)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject PinDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PinDialog.data,
      qt_meta_data_PinDialog,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void PinDialog::startTimer()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void PinDialog::finish(int _t1)
{
