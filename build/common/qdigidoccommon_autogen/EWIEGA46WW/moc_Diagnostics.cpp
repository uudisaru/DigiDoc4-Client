...
void Diagnostics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Diagnostics::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Diagnostics::update)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Diagnostics::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Diagnostics.data,
      qt_meta_data_Diagnostics,  qt_static_metacall, nullptr, nullptr}
};
...
void *Diagnostics::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QRunnable"))
        return static_cast< QRunnable*>(const_cast< Diagnostics*>(this));
...
// SIGNAL 0
void Diagnostics::update(const QString & _t1)
{
