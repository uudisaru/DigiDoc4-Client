...
QT_MOC_LITERAL(4, 32, 5) // "error"
    ...
    "Configuration\0finished\0\0changed\0error"
};
...
void Configuration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Configuration::*_t)(bool , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Configuration::finished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Configuration::finished(bool _t1, const QString & _t2)
{
